...
function applyExtraClass( extraProps, blockType, attributes ) {
    ...
    const { visibleOnTablet } = attributes;
    ...
    if ( typeof visibleOnTablet !== 'undefined' && !visibleOnTablet && allowedBlocks.includes( blockType.name ) ) {
        extraProps.className = classnames( extraProps.className, 'tablet-hidden' );
    }
